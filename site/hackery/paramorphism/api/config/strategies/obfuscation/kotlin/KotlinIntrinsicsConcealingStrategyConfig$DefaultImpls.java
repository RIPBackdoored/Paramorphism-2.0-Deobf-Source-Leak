...
public final class KotlinIntrinsicsConcealingStrategyConfig$DefaultImpls {
   @Nullable
   public static Boolean getEnabled(KotlinIntrinsicsConcealingStrategyConfig var0) {
      return StrategyConfiguration$DefaultImpls.getEnabled((StrategyConfiguration)var0);
   }

   @NotNull
   public static StrategyIrregularity[] getIrregularities(KotlinIntrinsicsConcealingStrategyConfig var0) {
      return StrategyConfiguration$DefaultImpls.getIrregularities((StrategyConfiguration)var0);
   }

   @NotNull
   public static ElementMask getMask(KotlinIntrinsicsConcealingStrategyConfig var0) {
      return StrategyConfiguration$DefaultImpls.getMask((StrategyConfiguration)var0);
   }

   public static boolean getOverrideGlobalMask(KotlinIntrinsicsConcealingStrategyConfig var0) {
