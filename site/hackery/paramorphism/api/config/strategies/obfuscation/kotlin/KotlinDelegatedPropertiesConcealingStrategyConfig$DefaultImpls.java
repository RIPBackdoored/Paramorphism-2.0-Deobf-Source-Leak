...
public final class KotlinDelegatedPropertiesConcealingStrategyConfig$DefaultImpls {
   @Nullable
   public static Boolean getEnabled(KotlinDelegatedPropertiesConcealingStrategyConfig var0) {
      return StrategyConfiguration$DefaultImpls.getEnabled((StrategyConfiguration)var0);
   }

   @NotNull
   public static StrategyIrregularity[] getIrregularities(KotlinDelegatedPropertiesConcealingStrategyConfig var0) {
      return StrategyConfiguration$DefaultImpls.getIrregularities((StrategyConfiguration)var0);
   }

   @NotNull
   public static ElementMask getMask(KotlinDelegatedPropertiesConcealingStrategyConfig var0) {
      return StrategyConfiguration$DefaultImpls.getMask((StrategyConfiguration)var0);
   }

   public static boolean getOverrideGlobalMask(KotlinDelegatedPropertiesConcealingStrategyConfig var0) {
