...
@Metadata(
   ...
   d2 = {"Lsite/hackery/paramorphism/api/config/strategies/corruption/NullByteNamingStrategyConfig;", "Lsite/hackery/paramorphism/api/config/StrategyConfiguration;", "irregularities", "", "Lsite/hackery/paramorphism/api/config/StrategyIrregularity;", "getIrregularities", "()[Lsite/hackery/paramorphism/api/config/StrategyIrregularity;", "paramorphism"}
)
public interface NullByteNamingStrategyConfig extends StrategyConfiguration {
   @NotNull
