...
public class OsXNativePty extends JnaNativePty {
   ...
   public static OsXNativePty current() throws IOException {
      ...
      return new OsXNativePty(-1, (FileDescriptor)null, var0, FileDescriptor.in, 1, FileDescriptor.out, var3);
   }
   ...
   public Size getSize() throws IOException {
      ...
      C_LIBRARY.ioctl(this.getSlave(), new NativeLong(1074295912L), var1);
      return var1.toSize();
   }

   public void setSize(Size var1) throws IOException {
      CLibrary$winsize var2 = new CLibrary$winsize(var1);
      C_LIBRARY.ioctl(this.getSlave(), new NativeLong(2148037735L), var2);
   }
