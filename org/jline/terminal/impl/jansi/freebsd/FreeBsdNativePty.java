...
public class FreeBsdNativePty extends JansiNativePty {
   ...
   public static FreeBsdNativePty current() throws IOException {
      FreeBsdNativePty var10000;
      try {
         String var0 = ttyname();
         var10000 = new FreeBsdNativePty(-1, (FileDescriptor)null, 0, FileDescriptor.in, 1, FileDescriptor.out, var0);
   ...
   public static FreeBsdNativePty open(Attributes var0, Size var1) throws IOException {
      int[] var2 = new int[1];
      int[] var3 = new int[1];
      ...
      return new FreeBsdNativePty(var2[0], newDescriptor(var2[0]), var3[0], newDescriptor(var3[0]), var6);
   }

   public FreeBsdNativePty(int var1, FileDescriptor var2, int var3, FileDescriptor var4, String var5) {
      super(var1, var2, var3, var4, var5);
   }

   public FreeBsdNativePty(int var1, FileDescriptor var2, int var3, FileDescriptor var4, int var5, FileDescriptor var6, String var7) {
   ...
   static Termios termios(Attributes var0) {
      ...
      var1.c_oflag = setFlag(var0.getOutputFlag(Attributes$OutputFlag.TABDLY), 4L, var1.c_oflag);
      ...
      var1.c_lflag = setFlag(var0.getLocalFlag(Attributes$LocalFlag.PENDIN), 33554432L, var1.c_lflag);
      var1.c_lflag = setFlag(var0.getLocalFlag(Attributes$LocalFlag.NOFLSH), 134217728L, var1.c_lflag);
   ...
   protected Attributes toAttributes(Termios var1) {
      ...
      addFlag(var1.c_oflag, var4, Attributes$OutputFlag.TABDLY, 4);
      ...
      addFlag(var1.c_lflag, var6, Attributes$LocalFlag.PENDIN, 33554432);
      addFlag(var1.c_lflag, var6, Attributes$LocalFlag.NOFLSH, 134217728);
