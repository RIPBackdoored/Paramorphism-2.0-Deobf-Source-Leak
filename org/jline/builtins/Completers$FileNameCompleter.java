...
public class Completers$FileNameCompleter implements Completer {
   static final boolean $assertionsDisabled = !Completers.class.desiredAssertionStatus();

   public Completers$FileNameCompleter() {
      super();
   }
   ...
   public void complete(LineReader var1, ParsedLine var2, List var3) {
      if (!$assertionsDisabled && var2 == null) {
         ...
         try {
            DirectoryStream var9 = Files.newDirectoryStream(var5, this::accept);
            Throwable var10 = null;
            boolean var19 = false;

            try {
               var19 = true;
               var9.forEach(this::lambda$complete$0);
               var19 = false;
