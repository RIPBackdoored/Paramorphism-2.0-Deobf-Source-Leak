...
public final class qo extends Lambda implements Function2 {
   public final MethodWrapper bdl;
   ...
   public final void a(@NotNull IInstructionWrapper var1, @NotNull String var2) {
      if (var2.length() > 32627) {
         ...
         MethodInstruction.addInvokeSpecial(var1, Reflection.getOrCreateKotlinClass(StringBuilder.class), "<init>", this.bdl.be());
