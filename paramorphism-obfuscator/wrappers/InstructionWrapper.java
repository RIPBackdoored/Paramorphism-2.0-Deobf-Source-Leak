...
public final class InstructionWrapper implements IInstructionWrapper, xl, yi, IAccess, IPrimitives {
   @NotNull
   ...
   public InstructionWrapper(@NotNull InsnList var1, @NotNull List var2) {
      super();
