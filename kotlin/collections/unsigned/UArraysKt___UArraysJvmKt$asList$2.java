...
@Metadata(
   ...
   d2 = {"kotlin/collections/unsigned/UArraysKt___UArraysJvmKt$asList$2", "Lkotlin/collections/AbstractList;", "Lkotlin/ULong;", "Ljava/util/RandomAccess;", "Lkotlin/collections/RandomAccess;", "size", "", "getSize", "()I", "contains", "", "element", "contains-VKZWuLQ", "(J)Z", "get", "index", "indexOf", "indexOf-VKZWuLQ", "(J)I", "isEmpty", "lastIndexOf", "lastIndexOf-VKZWuLQ", "kotlin-stdlib"}
)
public final class UArraysKt___UArraysJvmKt$asList$2 extends AbstractList implements RandomAccess {
   ...
   public ULong get(int var1) {
      return ULong.box-impl(ULongArray.get-impl(this.$this_asList, var1));
   }
   ...
   public int indexOf_VKZWuLQ/* $FF was: indexOf-VKZWuLQ*/(long var1) {
      long[] var3 = this.$this_asList;
      boolean var4 = false;
      boolean var8 = false;
      return ArraysKt.indexOf(var3, var1);
   }

   public final int indexOf(Object var1) {
      return var1 instanceof ULong ? this.indexOf-VKZWuLQ(((ULong)var1).unbox-impl()) : -1;
   }
   ...
   public int lastIndexOf_VKZWuLQ/* $FF was: lastIndexOf-VKZWuLQ*/(long var1) {
      ...
      boolean var4 = false;
      boolean var8 = false;
      return ArraysKt.lastIndexOf(var3, var1);
   }

   public final int lastIndexOf(Object var1) {
      return var1 instanceof ULong ? this.lastIndexOf-VKZWuLQ(((ULong)var1).unbox-impl()) : -1;
   }

   UArraysKt___UArraysJvmKt$asList$2(long[] var1) {
      super();
