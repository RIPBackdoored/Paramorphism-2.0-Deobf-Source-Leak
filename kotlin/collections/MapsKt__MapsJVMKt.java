...
class MapsKt__MapsJVMKt extends MapsKt__MapWithDefaultKt {
   ...
   public static final Map mapOf(@NotNull Pair var0) {
      return Collections.singletonMap(var0.getFirst(), var0.getSecond());
   }

   public static final Object getOrPut(@NotNull ConcurrentMap var0, Object var1, @NotNull Function0 var2) {
      byte var3 = 0;
   ...
   @NotNull
   public static final SortedMap toSortedMap(@NotNull Map var0) {
      return (SortedMap)(new TreeMap(var0));
   }

   @NotNull
   public static final SortedMap toSortedMap(@NotNull Map var0, @NotNull Comparator var1) {
   ...
   @NotNull
   public static final SortedMap sortedMapOf(@NotNull Pair... var0) {
   ...
   @InlineOnly
   private static final Properties toProperties(@NotNull Map var0) {
      byte var1 = 0;
   ...
   @InlineOnly
   private static final Map toSingletonMapOrSelf(@NotNull Map var0) {
      byte var1 = 0;
      return MapsKt.toSingletonMap(var0);
   }

   @NotNull
   public static final Map toSingletonMap(@NotNull Map var0) {
      Object var1 = var0.entrySet().iterator().next();
      boolean var2 = false;
      boolean var3 = false;
      Entry var4 = (Entry)var1;
      boolean var5 = false;
      return Collections.singletonMap(var4.getKey(), var4.getValue());
   }
