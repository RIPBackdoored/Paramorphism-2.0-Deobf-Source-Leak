...
public final class TransformingIndexedSequence implements Sequence {
   ...
   public TransformingIndexedSequence(@NotNull Sequence var1, @NotNull Function2 var2) {
      super();
      this.sequence = var1;
      this.transformer = var2;
   }

   public static final Function2 access$getTransformer$p(TransformingIndexedSequence var0) {
      return var0.transformer;
   }

   public static final Sequence access$getSequence$p(TransformingIndexedSequence var0) {
