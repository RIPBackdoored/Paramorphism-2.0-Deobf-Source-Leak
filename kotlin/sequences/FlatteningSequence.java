...
public final class FlatteningSequence implements Sequence {
   ...
   public FlatteningSequence(@NotNull Sequence var1, @NotNull Function1 var2, @NotNull Function1 var3) {
      super();
      this.sequence = var1;
   ...
   public static final Function1 access$getIterator$p(FlatteningSequence var0) {
      return var0.iterator;
   }

   public static final Function1 access$getTransformer$p(FlatteningSequence var0) {
      return var0.transformer;
   }

   public static final Sequence access$getSequence$p(FlatteningSequence var0) {
