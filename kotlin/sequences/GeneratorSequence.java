...
final class GeneratorSequence implements Sequence {
   ...
   public GeneratorSequence(@NotNull Function0 var1, @NotNull Function1 var2) {
      super();
      this.getInitialValue = var1;
      this.getNextValue = var2;
   }

   public static final Function0 access$getGetInitialValue$p(GeneratorSequence var0) {
      return var0.getInitialValue;
   }

   public static final Function1 access$getGetNextValue$p(GeneratorSequence var0) {
      return var0.getNextValue;
   }
}
