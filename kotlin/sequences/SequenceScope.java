...
public abstract class SequenceScope {
   ...
   @Nullable
   public final Object yieldAll(@NotNull Iterable var1, @NotNull Continuation var2) {
      return var1 instanceof Collection && ((Collection)var1).isEmpty() ? Unit.INSTANCE : this.yieldAll(var1.iterator(), var2);
   }

   @Nullable
   public final Object yieldAll(@NotNull Sequence var1, @NotNull Continuation var2) {
      return this.yieldAll(var1.iterator(), var2);
   }
