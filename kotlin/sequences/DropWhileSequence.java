...
public final class DropWhileSequence implements Sequence {
   ...
   public DropWhileSequence(@NotNull Sequence var1, @NotNull Function1 var2) {
      super();
      this.sequence = var1;
      this.predicate = var2;
   }

   public static final Function1 access$getPredicate$p(DropWhileSequence var0) {
      return var0.predicate;
   }

   public static final Sequence access$getSequence$p(DropWhileSequence var0) {
