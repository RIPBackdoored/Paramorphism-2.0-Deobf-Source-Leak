...
public final class TransformingSequence implements Sequence {
   ...
   @NotNull
   public final Sequence flatten$kotlin_stdlib(@NotNull Function1 var1) {
      return (Sequence)(new FlatteningSequence(this.sequence, this.transformer, var1));
   }

   public TransformingSequence(@NotNull Sequence var1, @NotNull Function1 var2) {
      super();
      this.sequence = var1;
      this.transformer = var2;
   }

   public static final Function1 access$getTransformer$p(TransformingSequence var0) {
      return var0.transformer;
   }

   public static final Sequence access$getSequence$p(TransformingSequence var0) {
