...
public final class TakeWhileSequence implements Sequence {
   ...
   public TakeWhileSequence(@NotNull Sequence var1, @NotNull Function1 var2) {
      super();
      this.sequence = var1;
      this.predicate = var2;
   }

   public static final Function1 access$getPredicate$p(TakeWhileSequence var0) {
      return var0.predicate;
   }

   public static final Sequence access$getSequence$p(TakeWhileSequence var0) {
