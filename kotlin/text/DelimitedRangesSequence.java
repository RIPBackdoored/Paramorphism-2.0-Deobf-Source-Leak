...
final class DelimitedRangesSequence implements Sequence {
   ...
   public DelimitedRangesSequence(@NotNull CharSequence var1, int var2, int var3, @NotNull Function2 var4) {
      super();
      this.input = var1;
   ...
   public static final int access$getLimit$p(DelimitedRangesSequence var0) {
      return var0.limit;
   }

   public static final CharSequence access$getInput$p(DelimitedRangesSequence var0) {
      return var0.input;
   }

   public static final Function2 access$getGetNextMatch$p(DelimitedRangesSequence var0) {
      return var0.getNextMatch;
   }

   public static final int access$getStartIndex$p(DelimitedRangesSequence var0) {
