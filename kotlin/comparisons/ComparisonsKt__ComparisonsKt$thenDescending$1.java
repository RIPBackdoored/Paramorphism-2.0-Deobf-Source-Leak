...
final class ComparisonsKt__ComparisonsKt$thenDescending$1 implements Comparator {
   final Comparator $this_thenDescending;
   final Comparator $comparator;

   public final int compare(Object var1, Object var2) {
      int var3 = this.$this_thenDescending.compare(var1, var2);
      return var3 != 0 ? var3 : this.$comparator.compare(var2, var1);
   }

   ComparisonsKt__ComparisonsKt$thenDescending$1(Comparator var1, Comparator var2) {
      super();
