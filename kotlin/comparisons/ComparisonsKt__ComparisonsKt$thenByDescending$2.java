...
public final class ComparisonsKt__ComparisonsKt$thenByDescending$2 implements Comparator {
   ...
   public final int compare(Object var1, Object var2) {
      ...
      if (var3 != 0) {
         ...
         boolean var5 = false;
         var10000 = var4.compare(this.$selector.invoke(var2), this.$selector.invoke(var1));
      }

      return var10000;
   }

   public ComparisonsKt__ComparisonsKt$thenByDescending$2(Comparator var1, Comparator var2, Function1 var3) {
      super();
