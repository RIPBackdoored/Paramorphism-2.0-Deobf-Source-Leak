...
final class NotNullVar implements ReadWriteProperty {
   ...
   public Object getValue(@Nullable Object var1, @NotNull KProperty var2) {
      ...
      if (var10000 != null) {
         ...
         throw (Throwable)(new IllegalStateException("Property " + var2.getName() + " should be initialized before get."));
      }
   }

   public void setValue(@Nullable Object var1, @NotNull KProperty var2, @NotNull Object var3) {
      this.value = var3;
   }
