...
public abstract class ObservableProperty implements ReadWriteProperty {
   ...
   public Object getValue(@Nullable Object var1, @NotNull KProperty var2) {
      return this.value;
   }

   public void setValue(@Nullable Object var1, @NotNull KProperty var2, Object var3) {
      Object var4 = this.value;
      if (this.beforeChange(var2, var4, var3)) {
         this.value = var3;
         this.afterChange(var2, var4, var3);
      }
   }
