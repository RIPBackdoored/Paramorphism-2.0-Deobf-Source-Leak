...
final class ContinuationInterceptorMigration implements ContinuationInterceptor {
   ...
   @NotNull
   public Continuation interceptContinuation(@NotNull Continuation var1) {
   ...
   public ContinuationInterceptorMigration(@NotNull kotlin.coroutines.experimental.ContinuationInterceptor var1) {
      super();
