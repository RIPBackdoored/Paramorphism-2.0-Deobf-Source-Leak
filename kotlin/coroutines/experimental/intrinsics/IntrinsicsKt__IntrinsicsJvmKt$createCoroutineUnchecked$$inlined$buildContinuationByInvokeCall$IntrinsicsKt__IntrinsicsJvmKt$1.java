...
public static final class IntrinsicsKt__IntrinsicsJvmKt$createCoroutineUnchecked$$inlined$buildContinuationByInvokeCall$IntrinsicsKt__IntrinsicsJvmKt$1 implements Continuation<Unit> {
    final Continuation $completion;
    final Function1 $this_createCoroutineUnchecked$inlined;
    final Continuation $completion$inlined;
    
    public IntrinsicsKt__IntrinsicsJvmKt$createCoroutineUnchecked$$inlined$buildContinuationByInvokeCall$IntrinsicsKt__IntrinsicsJvmKt$1(final Continuation $completion, final Function1 $this_createCoroutineUnchecked$inlined, final Continuation $completion$inlined) {
