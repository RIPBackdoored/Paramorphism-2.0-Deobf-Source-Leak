...
public static final class IntrinsicsKt__IntrinsicsJvmKt$createCoroutineUnintercepted$$inlined$createCoroutineFromSuspendFunction$IntrinsicsKt__IntrinsicsJvmKt$3 extends RestrictedContinuationImpl {
    private int label;
    final Continuation $completion;
    final Function2 $this_createCoroutineUnintercepted$inlined;
    final Object $receiver$inlined;
    
    public IntrinsicsKt__IntrinsicsJvmKt$createCoroutineUnintercepted$$inlined$createCoroutineFromSuspendFunction$IntrinsicsKt__IntrinsicsJvmKt$3(final Continuation $completion, final Continuation continuation, final Function2 $this_createCoroutineUnintercepted$inlined, final Object $receiver$inlined) {
    ...
    protected Object invokeSuspend(@NotNull final Object o) {
        ...
        switch (this.label) {
            case 0: {
                ...
                invoke = ((Function2)TypeIntrinsics.beforeCheckcastToFunctionOfArity($this_createCoroutineUnintercepted$inlined, 2)).invoke(this.$receiver$inlined, restrictedContinuationImpl);
                break;
            }
            case 1: {
                this.label = 2;
