...
public abstract class RestrictedSuspendLambda extends RestrictedContinuationImpl implements FunctionBase, SuspendFunction {
   ...
   public String toString() {
      return this.getCompletion() == null ? Reflection.renderLambdaToString((FunctionBase)this) : super.toString();
   }
   ...
   public RestrictedSuspendLambda(int var1, @Nullable Continuation var2) {
      super(var2);
      this.arity = var1;
   }
