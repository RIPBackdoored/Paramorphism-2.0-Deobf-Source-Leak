...
public final class SafeContinuation<T> implements Continuation<T>, CoroutineStackFrame
{
    ...
    public void resumeWith(@NotNull final Object o) {
        while (true) {
            ...
            if (result == CoroutineSingletons.UNDECIDED) {
                if (SafeContinuation.RESULT.compareAndSet(this, CoroutineSingletons.UNDECIDED, o)) {
                    return;
                }
                continue;
            }
    ...
    public final Object getOrThrow() {
        ...
        if (o == CoroutineSingletons.UNDECIDED) {
