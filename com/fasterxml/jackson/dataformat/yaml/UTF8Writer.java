...
public final class UTF8Writer extends Writer {
   ...
   public UTF8Writer(OutputStream var1) {
      super();
      this._out = var1;
      this._bufferHolder = _findBufferHolder();
      byte[] var2 = this._bufferHolder[0];
      if (var2 == null) {
         var2 = new byte[8000];
      } else {
