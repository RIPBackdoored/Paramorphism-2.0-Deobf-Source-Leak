...
public class AsExistingPropertyTypeSerializer extends AsPropertyTypeSerializer {
   public AsExistingPropertyTypeSerializer(TypeIdResolver var1, BeanProperty var2, String var3) {
      super(var1, var2, var3);
   }

   public AsExistingPropertyTypeSerializer forProperty(BeanProperty var1) {
      return this._property == var1 ? this : new AsExistingPropertyTypeSerializer(this._idResolver, var1, this._typePropertyName);
   }
