...
public class StdArraySerializers$DoubleArraySerializer extends ArraySerializerBase {
   ...
   protected StdArraySerializers$DoubleArraySerializer(StdArraySerializers$DoubleArraySerializer var1, BeanProperty var2, Boolean var3) {
      super(var1, var2, var3);
   }

   public JsonSerializer _withResolved(BeanProperty var1, Boolean var2) {
      return new StdArraySerializers$DoubleArraySerializer(this, var1, var2);
   }
   ...
   public boolean isEmpty(SerializerProvider var1, double[] var2) {
      return var2.length == 0;
   }

   public boolean hasSingleElement(double[] var1) {
      return var1.length == 1;
   }

   public final void serialize(double[] var1, JsonGenerator var2, SerializerProvider var3) throws IOException {
      int var4 = var1.length;
      if (var4 == 1 && this._shouldUnwrapSingle(var3)) {
         this.serializeContents(var1, var2, var3);
      } else {
         var2.setCurrentValue(var1);
         var2.writeArray((double[])var1, 0, var1.length);
      }
   }

   public void serializeContents(double[] var1, JsonGenerator var2, SerializerProvider var3) throws IOException {
      int var4 = 0;
   ...
   public void serializeContents(Object var1, JsonGenerator var2, SerializerProvider var3) throws IOException {
      this.serializeContents((double[])var1, var2, var3);
   }

   public void serialize(Object var1, JsonGenerator var2, SerializerProvider var3) throws IOException {
      this.serialize((double[])var1, var2, var3);
   }

   public boolean hasSingleElement(Object var1) {
      return this.hasSingleElement((double[])var1);
   }

   public boolean isEmpty(SerializerProvider var1, Object var2) {
      return this.isEmpty(var1, (double[])var2);
   }
